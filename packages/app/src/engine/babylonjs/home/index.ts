...
} from "@babylonjs/core/Meshes/Builders/planeBuilder";
...
export function renderHome(canvas: HTMLCanvasElement) {
  ...
  const amigaTexture = new Texture(
    "https://cdn.jsdelivr.net/gh/ZoeLeee/cdn/img/village/20111208032646806585.jpg",
    scene
  );
